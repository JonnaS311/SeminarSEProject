export function createTaskCard(task, { onDelete, onMove, onTogglePriority }) {
        ...
        <div class="task-footer">
            <div class="task-actions">
                <button class="${priorityClass}">
                  <img src="./static/images/star.svg" alt="Star" width="16" height="16">
                </button>
                <button class="delete">
                  <img src="./static/images/del.svg" alt="Delete" width="16" height="16">
                </button>
            </div>
            <button class="task-send">
  ...
  div.querySelector(`.task-actions .${priorityClass}`)
    .onclick = () => onTogglePriority(task.task_id);
